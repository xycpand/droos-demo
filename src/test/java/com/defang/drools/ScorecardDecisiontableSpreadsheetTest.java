...
import com.defang.scorecard_decisiontable_spreadsheet.Applicant;



@RunWith(SpringRunner.class)
public class ScorecardDecisiontableSpreadsheetTest {
   
    private static final String SERVER_URL = "http://192.168.80.236:8180/kie-server/services/rest/server";
	private static final String USERNAME = "kieserver";
	private static final String PASSWORD = "kieserver1!";
	private static final String KIE_CONTAINER_ID = "scorecard_decisiontable_spreadsheet_1.0.0-SNAPSHOT";
	private static final String KIE_SESSION_ID = "scorecard_decisiontable_spreadsheet";
	  ...
	  public void testKieServer() {
		// KisService 配置信息设置
	        ...
	        Applicant applicant = new Applicant(33,"1","2","0",0);
