...
import com.defang.guided_decision_tables.entity.Applicant;




@RunWith(SpringRunner.class)
public class GuidedDecisionTablesTest {
   
    private static final String SERVER_URL = "http://192.168.80.236:8180/kie-server/services/rest/server";
	private static final String USERNAME = "kieserver";
	private static final String PASSWORD = "kieserver1!";
	private static final String KIE_CONTAINER_ID = "guided_decision_tables_1.0.0-SNAPSHOT";
	private static final String KIE_SESSION_ID = "guided_decision_tables";
    
	  @Test
	  public void testGuidedDecisionTables() {
		// KisService 配置信息设置
	        ...
	        // 规则输入条件
	        Applicant applicant = new Applicant(23);
