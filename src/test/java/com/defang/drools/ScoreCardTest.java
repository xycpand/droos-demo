...
public class ScoreCardTest {
	...
	private static final String KIE_CONTAINER_ID = "scorecard_1.0.0-SNAPSHOT";
	private static final String KIE_SESSION_ID = "scorecard";
	  ...
	  public void testKieServer() {
		// KisService 配置信息设置
	        ...
	        Applicant applicant = new Applicant(23,"1","2","0",0);
